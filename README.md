...
1. Clone o Repositório: Faça um clone deste repositório em seu sistema local.
2 Crie um Schemma no MYSQL
3. Configure o Arquivo .env: No diretório do projeto, localize o arquivo .env e configure a variável DB_DATABASE com o nome do Schema que você criou no passo anterior.
4. Instale as Dependências: Abra o terminal na pasta do projeto e execute o comando composer install para instalar todas as dependências do Laravel.
